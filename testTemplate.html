...
<div class="w3-content w3-container " id="experience" >
  ...
  <p>I'm currently working in at the Academic Technologies department at the University of Texas El Paso as
  an Undergraduate Assistant. I started working here in December of 2016 and have learned tons since then.
  I'm confident that the skills i've learned working here will help me in my future professional career.
  I hope to get the opportunity to use those skills in a software related job as soon as I graduate.</p>
...
<footer class="w3-center w3-black w3-padding-16 ">
  ...
  <a href="http://facebook.com"> <i class="fa fa-facebook fa-2x w3-hover-opacity"></i></a>
  <a href="http://facebook.com"> <i class="fa fa-instagram fa-2x w3-hover-opacity"></i></a>
  <a href="http://facebook.com"> <i class="fa fa-twitter fa-2x w3-hover-opacity"></i></a>
  <a href="http://facebook.com"> <i class="fa fa-linkedin fa-2x w3-hover-opacity"></i></a>
